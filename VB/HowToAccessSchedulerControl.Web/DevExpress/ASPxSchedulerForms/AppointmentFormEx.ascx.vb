...
'INSTANT VB NOTE: The variable recurrenceControl was renamed since Visual Basic does not allow variables and other class members to have the same name:
    Private _recurrenceControl As AppointmentRecurrenceControl
    ...
    Protected Sub RenderRecurrenceControl(ByVal isRecurring As Boolean)
        If Me._recurrenceControl IsNot Nothing Then
            Me._recurrenceControl.Visible = isRecurring
            Return
        End If
        Dim container As AppointmentFormTemplateContainer = CType(Parent, AppointmentFormTemplateContainer)
        Me._recurrenceControl = New AppointmentRecurrenceControl()
        _recurrenceControl.ID = "RecurrenceControl1"
        _recurrenceControl.Visible = isRecurring 'container.ShouldShowRecurrence;
        _recurrenceControl.DayNumber = container.RecurrenceDayNumber
        _recurrenceControl.End = container.RecurrenceEnd
        _recurrenceControl.Month = container.RecurrenceMonth
        _recurrenceControl.OccurrenceCount = container.RecurrenceOccurrenceCount
        _recurrenceControl.Periodicity = container.RecurrencePeriodicity
        _recurrenceControl.RecurrenceRange = container.RecurrenceRange
        _recurrenceControl.Start = container.RecurrenceStart
        _recurrenceControl.WeekDays = container.RecurrenceWeekDays
        _recurrenceControl.WeekOfMonth = container.RecurrenceWeekOfMonth
        _recurrenceControl.RecurrenceType = container.RecurrenceType
        _recurrenceControl.IsFormRecreated = container.IsFormRecreated
        RecurrencePanel.Controls.Add(_recurrenceControl)
        _recurrenceControl.EditorsInfo = New EditorsInfo(container.Control, container.Control.Styles.FormEditors, container.Control.Images.FormEditors, container.Control.Styles.Buttons)
    End Sub
End Class
