...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v13.2" Namespace="DevExpress.Web.ASPxScheduler.Controls" TagPrefix="dxsc" %>
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v13.2" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dxwschs" %>
