														...
														<td class="propGroupContentCell">                                                                                                                
															<table cellpadding="0" cellspacing="0">
																...
																<tr>
																	...
																	<% =HtmlEditor.ClientID + "_dxeWidthSpinEditCell"%>' colspan="2">
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td>                                                                                
																					<dxe:ASPxSpinEdit ID="txbWidth" ClientInstanceName="_dxeTxbTableWidth" runat="server" Height="21px"
																						Number="0" Width="57px" AllowNull="False" NumberType="Integer" MaxValue="10000"
																						MinValue="0">
																					</dxe:ASPxSpinEdit>                                                                                    
																				</td>
																				<td class="rowsInputCell">
																...
																<tr>
																	...
																	<td class="rowsInputCell" style="visibility: hidden;" id='
																	<% =HtmlEditor.ClientID + "_dxeHeightSpinEditCell"%>' colspan="2">
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td>                                                                                
