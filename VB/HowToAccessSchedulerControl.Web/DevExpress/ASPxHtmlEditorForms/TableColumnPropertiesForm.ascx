...
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v10.1, Version=10.1.2.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor"
	TagPrefix="dxhe" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.1, Version=10.1.2.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors"
	TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.v10.1, Version=10.1.2.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPanel"
	TagPrefix="dxp" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.1, Version=10.1.2.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v10.1, Version=10.1.2.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor" TagPrefix="dxhe" %>
<%@ Register Assembly="DevExpress.Web.v10.1, Version=10.1.2.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dxp" %>
												...
												<table cellpadding="0" cellspacing="0">
													...
													<tr>
														<td class="propGroupContentCell">                                                                                                                
															<table cellpadding="0" cellspacing="0">
																<tr id='
																<% =HtmlEditor.ClientID + "_dxeColumnWidthCell"%>'>
																	...
																	<td class="rowsInputCell" style="visibility: hidden;" id='
																	<% =HtmlEditor.ClientID + "_dxeColumnWidthSpinEditCell"%>' colspan="2">                                                                        
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td>                                                                                
																...
																<tr id='
																<% =HtmlEditor.ClientID + "_dxeColumnHeightCell"%>'>
																	<td class="captionCell">
																	...
																	<td class="rowsInputCell" style="visibility: hidden;" id='
																	<% =HtmlEditor.ClientID + "_dxeRowHeightSpinEditCell"%>' colspan="2">
																		<table cellpadding="0" cellspacing="0">
																			<tr>
																				<td>                                                                                
...
<script type="text/javascript" id="dxss_TableColumnForm">
	...
	function OnCmdWidthSelectedIndexChanged_TableColumnForm(widthCombox) {
		_aspxSetElementVisibility(_aspxGetElementById('
		<% =HtmlEditor.ClientID + "_dxeColumnWidthSpinEditCell"%>'), widthCombox.GetValue() == "custom");
	}
	function OnCmdHeightSelectedIndexChanged_TableColumnForm(heightCombox) {
		_aspxSetElementVisibility(_aspxGetElementById('
		<% =HtmlEditor.ClientID + "_dxeRowHeightSpinEditCell"%>'), heightCombox.GetValue() == "custom");
	}
</script>
