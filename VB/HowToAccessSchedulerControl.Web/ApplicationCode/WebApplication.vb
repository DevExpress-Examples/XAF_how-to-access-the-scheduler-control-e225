...
Partial Public Class HowToAccessSchedulerControlAspNetApplication
   ...
   Friend WithEvents SchedulerAspNetModule1 As DevExpress.ExpressApp.Scheduler.Web.SchedulerAspNetModule
	...
	Private Sub InitializeComponent()
      ...
      'module3
      '
      Me.module3.AdditionalBusinessClasses.Add(GetType(DevExpress.Persistent.BaseImpl.[Event]))
      '
      'module5
      '
      ...
      'sqlConnection1
      '
      Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=HowToAccessSchedulerControl;Integrated Securi" & _
          "ty=SSPI;Pooling=false"
      Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
      '
      'SchedulerAspNetModule1
      '
      Me.SchedulerAspNetModule1.Description = "Uses the ASPxScheduler controls suite to display DevExpress.Persistent.Base.IEven" & _
